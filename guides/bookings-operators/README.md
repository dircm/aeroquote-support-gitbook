---
description: Manage confirmed flights from acceptance to completion.
...
{% content-ref url="passengers-and-cargo.md" %}
[passengers-and-cargo.md](passengers-and-cargo.md)
{% endcontent-ref %}

{% content-ref url="crew-assignment.md" %}
[crew-assignment.md](crew-assignment.md)
{% endcontent-ref %}
