...
| **Quote Already Created** | A quote has been generated — the request links to it |

## Guides

The flow differs slightly depending on whether you operate your own fleet or broker across external operators:
