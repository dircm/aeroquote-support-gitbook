...
{% hint style="info" %}
Widget enquiries are automatically created as requests in AeroQuote. The email is a notification that a new request is waiting for your review. See [Widgets](../../widgets/) for setup instructions.
{% endhint %}
