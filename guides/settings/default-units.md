...
* **Default parking duration** - This is the time period - on the ground - AeroQuote will add when you add a [Quote Stop](../quotes/add-a-stop-between-two-airports.md) or a [Booking Stop](/broken/pages/vfmEogfoypTvesZNQYTR). This period is also used when AeroQuote adds a ferry flight automatically.
...
* **Default Fuel Unit for prices** - At many airports, you will find AeroQuote has an up-to-date record of fuel prices available. When adding a fuel uplift, this unit will be used but you can change it when editing a quote at any time. The same preferred unit is used when AeroQuote shows **planned fuel burn** for advanced performance aircraft — on estimate tables (Requests, Quote Builder, Booking Builder) and on saved quote/booking legs, option totals, crew itinerary, and the flight manifest. That burn is for your team only and does not appear on customer quote or booking views or customer PDFs. Changing this unit updates how burn is displayed; it does not rewrite stored plan figures. See [Using the Estimator](../requests/using-the-estimator.md) and [Advanced performance models](../aircraft/advanced-performance.md).
